...
const streamChangesEndpoint =
  "https://raw.githubusercontent.com/manniL/lichter.io-twitch-status/main/latest.json";
            ...
            <AppLink
              ...
              :class="{
                '!border-red-500 text-red-500':
                  ...
                  item.activeRoutes.some((route) => $route.path.startsWith(route)),
              }"
