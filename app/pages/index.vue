...
const { data: articles } = useAsyncData("latest-articles", () =>
  queryCollection("articles")
    ...
    .select("id", "path", "title", "description", "datePublished", "dateModified", "topics")
    .limit(4)
    .all(),
);

const { data: talks } = useAsyncData("latest-speaking", () =>
  queryCollection("speaking")
    .order("date", "DESC")
    .select(
      "id",
      "path",
...
const { data: workshops } = useAsyncData("latest-workshops", () =>
  queryCollection("workshops")
    .select("id", "path", "title", "description", "time", "topics")
    .limit(3)
    .all(),
);
</script>
...
<template>
  <div>
      ...
      <div class="md:flex md:flex-row items-center">
        <div class="mt-8 md:mt-0 md:w-3/5 md:flex-1">
          <div class="flex gap-8 -mx-4 md:mx-0">
            ...
            <div class="md:hidden w-1/2">
              <NuxtPicture
                ...
                src="/img/alex-main.png"
                alt="Photo of Alexander Lichter"
              />
            </div>
          </div>
          <AppParagraph look="subParagraph" class="mt-8">
            Hey! I am Alex, a web engineering consultant based in Amsterdam. I help companies to
            build better web applications and to improve their knowledge, workflows, and culture.
          </AppParagraph>
          <AppParagraph look="subParagraph" class="mt-6">
            My expertise in JavaScript, TypeScript, Vue.js, and Nuxt.js is highly valued by clients
          ...
          <div class="mt-8 flex">
            ...
            <AppButton to="/about/" look="secondary"
              >About <span class="hidden sm:inline">me</span></AppButton
            >
          </div>
        ...
        <div
          class="w-1/2 md:w-2/5 md:flex-1 h-full hidden md:flex justify-end items-center md:ml-32 md:mt-8"
        >
          <NuxtPicture
            format="avif,webp,png"
            width="544"
    ...
    <AppSection class="my-32">
      <div class="flex flex-col gap-16 md:gap-8 md:flex-row justify-around">
        <ServicePreview icon="mdi:lightbulb-on-outline" title="Consulting" to="/consulting">
          Companies reach out to help them build better Vue and Nuxt applications - from solving
          problems to discussing the right abstractions and architecture.
        </ServicePreview>
        <ServicePreview icon="ph:chalkboard-teacher-light" title="Workshops" to="/workshops">
          Want to level up your team's skills? I offer workshops on Vue, Nuxt, TypeScript, testing
          and more topics. Don't hesitate to reach out and let's discuss your needs.
        </ServicePreview>
        <ServicePreview icon="ph:microphone" title="Public speaking" to="/speaking">
          I love to share my knowledge and experience with the community. I speak at conferences and
          meetups, and I am always open to new opportunities.
        </ServicePreview>
      </div>
    ...
    <AppSection class="mt-48 md:mt-32">
      <ParagraphDecoration />
      <AppParagraph class="mr-8 mt-4" tag="h2" look="heading"> Workshops </AppParagraph>
      <div class="flex flex-col gap-8 md:gap-0 md:flex-row justify-between">
        <AppParagraph look="subParagraph" class="mt-8 max-w-xl">
          Take your team's skills to the next level with my workshops on Vue, Nuxt, TypeScript,
          testing and various other topics.
        </AppParagraph>
        <div>
    ...
    <AppSection class="bg-zinc-900">
      ...
      <AppParagraph class="mr-8 mt-4" tag="h2" look="heading"> Articles </AppParagraph>
      <div class="flex flex-col gap-8 md:gap-0 md:flex-row justify-between">
        <AppParagraph look="subParagraph" class="mt-8 max-w-xl">
          I love to share my knowledge and experience with the community. Have a look at my latest
          articles below.
        </AppParagraph>
        <div>
          <AppButton to="/articles" look="secondary" secondary-after-bg="bg-zinc-900"
            >View all articles</AppButton
          >
        </div>
      </div>
    ...
    <AppSection>
      <ParagraphDecoration class="mt-16" />
      <AppParagraph class="mr-8 mt-4" tag="h2" look="heading"> Speaking </AppParagraph>
      <div class="flex flex-col gap-8 md:gap-0 md:flex-row justify-between">
        <AppParagraph look="subParagraph" class="mt-8 max-w-xl">
          Check out my latest talks, podcast episodes and other appearances, as well as upcoming
          events.
        </AppParagraph>
        <div>
